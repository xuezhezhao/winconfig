...
class Test_GetSites():
    ...
    def test_getsites(self,case_data):
        ...
        res=SiteMg().editSite(sitekey=regular(case_body['siteKey']),sitetype=case_body['siteType'],opendate=regular(case_body['openDate']),name=regular(case_body['siteName']),city=case_body['city'],regid=case_body['Region_Id'],proid=case_body['Province_Id'],cityid=case_body['City_Id'],areaid=case_body['Area_Id'],area=case_body['area']).json()['description']
